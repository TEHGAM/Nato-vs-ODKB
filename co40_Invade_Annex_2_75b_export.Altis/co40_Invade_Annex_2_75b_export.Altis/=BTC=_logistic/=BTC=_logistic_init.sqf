...
if (BTC_active_lift == 1) then
{
	...
	BTC_get_liftable_array =
	{
		...
		switch (typeOf _chopper) do
		{
			...
			//PO-30
			case "O_Heli_Light_02_F"     : {_array = ["Motorcycle","ReammoBox","ReammoBox_F","Strategic","StaticWeapon","Car","Truck","Wheeled_APC","Air","Ship"];};
			//UH80
			case "B_Heli_Transport_01_F" : {_array = ["Motorcycle","ReammoBox","ReammoBox_F","Strategic","StaticWeapon","Car","Truck","Wheeled_APC","Air","Ship"];};
			//CH49
			case "I_Heli_Transport_02_F" : {_array = ["Motorcycle","ReammoBox","ReammoBox_F","Strategic","StaticWeapon","Car","Truck","Wheeled_APC","Tracked_APC","APC_Tracked_01_base_F","APC_Tracked_02_base_F","Air","Ship","Tank","CAManBase","Cargo_base_F","Land_Cargo20_military_green_F"];};
...
SystemChat "=BTC= dragging Initialized.";